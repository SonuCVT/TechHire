      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <div className="container mx-auto flex gap-[30px]">
            ...
            <div className={`rounded-lg shadow-md p-6 mb-6 w-2/5 h-full transition-all ${
              ...
              <div className="flex flex-row md:flex-col">
                ...
                <div className="flex-1">
                  ...
                  <div className="mb-8">
                    <div className="flex justify-between items-center mb-2 relative">
                      <span className={`${darkMode ? "text-gray-300" : "text-gray-700"}`}>Profile completion</span>
                    ...
                    <div className={`w-full rounded-full h-2.5 ${darkMode ? "bg-gray-700" : "bg-gray-200"}`}>
                      <div className="bg-blue-500 h-2.5 rounded-full" style={{ width: `${candidateData.profileCompletion}%` }}></div>
                    </div>
                  </div>

                  {/* Skills, Education, Experience */}
                  <div className="grid grid-cols-1 gap-4">
                    <div className={`border-b py-3 flex justify-between ${darkMode ? "border-gray-700" : "border-gray-200"}`}>
                ...
                <div className="w-full mt-6 md:mt-0 flex flex-col items-center">
                  <div className="mt-8 w-full">
                    <div className={`border rounded-md p-4 ${darkMode ? "border-gray-700 bg-gray-800" : "border-gray-200 bg-gray-50"}`}>
                        ...
                        {candidateData.documents.map((doc, index) => (
                          <button
                            ...
                            className={`w-full py-2 px-4 border rounded-md text-center transition-all ${
                              darkMode ? "border-gray-600 bg-gray-700 text-white hover:bg-gray-600" : "border-gray-200 bg-white hover:bg-gray-50"
                            }`}
                          >
                            {doc.name}
                          </button>
