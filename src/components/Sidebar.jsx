...
const Sidebar = () => {
  const sidebarItems = [
    { icon: <LayoutDashboard size={18} />, label: 'Dashboard', active: true,link:"/" },
    { icon: <BellRing size={18} />, label: 'Notification', active: false ,link:"/notification"},
    { icon: <Briefcase size={18} />, label: 'Job Management', active: false ,link:"/jobmanagement"},
    { icon: <Users size={18} />, label: 'Candidates', active: false ,link:"/candidates"},
    { icon: <ClipboardCheck size={18} />, label: 'Assessments', active: false,link:"/assessments" },
    { icon: <MessageSquare size={18} />, label: 'Interviews', active: false ,link:"/interviews"},
    { icon: <Settings size={18} />, label: 'Settings', active: false ,link:"/setting"},
  ];
